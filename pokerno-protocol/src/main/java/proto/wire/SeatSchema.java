...
public class SeatSchema
       implements Schema<de.pokerno.protocol.wire.Seat> {
    ...
    static final Schema<de.pokerno.protocol.wire.Seat> SCHEMA = new SeatSchema();

    public static de.pokerno.protocol.wire.Seat getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<de.pokerno.protocol.wire.Seat> getSchema() { return SCHEMA; }
    ...
    public de.pokerno.protocol.wire.Seat newMessage() {
        return new de.pokerno.protocol.wire.Seat();
    }

    public Class<de.pokerno.protocol.wire.Seat> typeClass() {
        return de.pokerno.protocol.wire.Seat.class;
    }

    public String messageName() {
        return de.pokerno.protocol.wire.Seat.class.getSimpleName();
    }

    public String messageFullName() {
        return de.pokerno.protocol.wire.Seat.class.getName();
    }


    public boolean isInitialized(de.pokerno.protocol.wire.Seat message) {
        return true;
    }


    public void mergeFrom(Input input, de.pokerno.protocol.wire.Seat message) throws IOException {
    ...
    public void mergeFrom(Input input, de.pokerno.protocol.wire.Seat message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_STATE:
    ...
    public void writeTo(Output output, de.pokerno.protocol.wire.Seat message) throws IOException {
    ...
    public void writeTo(Output output, de.pokerno.protocol.wire.Seat message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_STATE:
