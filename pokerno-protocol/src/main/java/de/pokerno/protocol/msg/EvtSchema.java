...
public class EvtSchema
    ...
    static final Evt DEFAULT_INSTANCE = new Evt();
    static final Schema<Evt> SCHEMA = new EvtSchema();

    public static Evt getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<Evt> getSchema() { return SCHEMA; }
    ...
    public Evt newMessage() {
        return new Evt();
    }

    public Class<Evt> typeClass() {
        return Evt.class;
    }

    public String messageName() {
        return Evt.class.getSimpleName();
    }

    public String messageFullName() {
        return Evt.class.getName();
    }


    public boolean isInitialized(Evt message) {
        return true;
    }


    public void mergeFrom(Input input, Evt message) throws IOException {
    ...
    public void mergeFrom(Input input, Evt message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_TYPE:
    ...
    public void writeTo(Output output, Evt message) throws IOException {
    ...
    public void writeTo(Output output, Evt message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_TYPE:
