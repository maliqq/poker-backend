...
public class CmdSchema
       implements Schema<de.pokerno.protocol.msg.Cmd> {
    ...
    static final de.pokerno.protocol.msg.Cmd DEFAULT_INSTANCE = new de.pokerno.protocol.msg.Cmd();
    static final Schema<de.pokerno.protocol.msg.Cmd> SCHEMA = new CmdSchema();

    public static de.pokerno.protocol.msg.Cmd getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<de.pokerno.protocol.msg.Cmd> getSchema() { return SCHEMA; }
    ...
    public de.pokerno.protocol.msg.Cmd newMessage() {
        return new de.pokerno.protocol.msg.Cmd();
    }

    public Class<de.pokerno.protocol.msg.Cmd> typeClass() {
        return de.pokerno.protocol.msg.Cmd.class;
    }

    public String messageName() {
        return de.pokerno.protocol.msg.Cmd.class.getSimpleName();
    }

    public String messageFullName() {
        return de.pokerno.protocol.msg.Cmd.class.getName();
    }


    public boolean isInitialized(de.pokerno.protocol.msg.Cmd message) {
        return true;
    }


    public void mergeFrom(Input input, de.pokerno.protocol.msg.Cmd message) throws IOException {
    ...
    public void mergeFrom(Input input, de.pokerno.protocol.msg.Cmd message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_TYPE:
    ...
    public void writeTo(Output output, de.pokerno.protocol.msg.Cmd message) throws IOException {
    ...
    public void writeTo(Output output, de.pokerno.protocol.msg.Cmd message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_TYPE:
