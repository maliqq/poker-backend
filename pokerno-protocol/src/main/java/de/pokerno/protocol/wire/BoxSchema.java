...
public class BoxSchema
       implements Schema<Box> {


    static final Box DEFAULT_INSTANCE = new Box();
    static final Schema<Box> SCHEMA = new BoxSchema();

    public static Box getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<Box> getSchema() { return SCHEMA; }
    ...
    public boolean isInitialized(Box message) {
        return true;
    }


    public void mergeFrom(Input input, Box message) throws IOException {
    ...
    public void mergeFrom(Input input, Box message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_POS:
    ...
    public void writeTo(Output output, Box message) throws IOException {
    ...
    public void writeTo(Output output, Box message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_POS:
