...
public class StakeSchema
       implements Schema<de.pokerno.protocol.wire.Stake> {


    static final de.pokerno.protocol.wire.Stake DEFAULT_INSTANCE = new de.pokerno.protocol.wire.Stake();
    static final Schema<de.pokerno.protocol.wire.Stake> SCHEMA = new StakeSchema();

    public static de.pokerno.protocol.wire.Stake getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<de.pokerno.protocol.wire.Stake> getSchema() { return SCHEMA; }
    ...
    public de.pokerno.protocol.wire.Stake newMessage() {
        return new de.pokerno.protocol.wire.Stake();
    }

    public Class<de.pokerno.protocol.wire.Stake> typeClass() {
        return de.pokerno.protocol.wire.Stake.class;
    }

    public String messageName() {
        return de.pokerno.protocol.wire.Stake.class.getSimpleName();
    }

    public String messageFullName() {
        return de.pokerno.protocol.wire.Stake.class.getName();
    }


    public boolean isInitialized(de.pokerno.protocol.wire.Stake message) {
        return true;
    }


    public void mergeFrom(Input input, de.pokerno.protocol.wire.Stake message) throws IOException {
    ...
    public void mergeFrom(Input input, de.pokerno.protocol.wire.Stake message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
    ...
    public void writeTo(Output output, de.pokerno.protocol.wire.Stake message) throws IOException {
    ...
    public void writeTo(Output output, de.pokerno.protocol.wire.Stake message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_BIG_BLIND:
