...
public class HandSchema
       implements Schema<de.pokerno.protocol.wire.Hand> {
    ...
    static final de.pokerno.protocol.wire.Hand DEFAULT_INSTANCE = new de.pokerno.protocol.wire.Hand();
    static final Schema<de.pokerno.protocol.wire.Hand> SCHEMA = new HandSchema();

    public static de.pokerno.protocol.wire.Hand getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<de.pokerno.protocol.wire.Hand> getSchema() { return SCHEMA; }
    ...
    public de.pokerno.protocol.wire.Hand newMessage() {
        return new de.pokerno.protocol.wire.Hand();
    }

    public Class<de.pokerno.protocol.wire.Hand> typeClass() {
        return de.pokerno.protocol.wire.Hand.class;
    }

    public String messageName() {
        return de.pokerno.protocol.wire.Hand.class.getSimpleName();
    }

    public String messageFullName() {
        return de.pokerno.protocol.wire.Hand.class.getName();
    }


    public boolean isInitialized(de.pokerno.protocol.wire.Hand message) {
        return true;
    }


    public void mergeFrom(Input input, de.pokerno.protocol.wire.Hand message) throws IOException {
    ...
    public void mergeFrom(Input input, de.pokerno.protocol.wire.Hand message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_RANK:
    ...
    public void writeTo(Output output, de.pokerno.protocol.wire.Hand message) throws IOException {
    ...
    public void writeTo(Output output, de.pokerno.protocol.wire.Hand message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_RANK:
