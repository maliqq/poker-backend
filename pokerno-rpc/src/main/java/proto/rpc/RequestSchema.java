...
public class RequestSchema
       implements Schema<de.pokerno.protocol.rpc.Request> {
    ...
    static final de.pokerno.protocol.rpc.Request DEFAULT_INSTANCE = new de.pokerno.protocol.rpc.Request();
    static final Schema<de.pokerno.protocol.rpc.Request> SCHEMA = new RequestSchema();

    public static de.pokerno.protocol.rpc.Request getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<de.pokerno.protocol.rpc.Request> getSchema() { return SCHEMA; }
    ...
    public de.pokerno.protocol.rpc.Request newMessage() {
        return new de.pokerno.protocol.rpc.Request();
    }

    public Class<de.pokerno.protocol.rpc.Request> typeClass() {
        return de.pokerno.protocol.rpc.Request.class;
    }

    public String messageName() {
        return de.pokerno.protocol.rpc.Request.class.getSimpleName();
    }

    public String messageFullName() {
        return de.pokerno.protocol.rpc.Request.class.getName();
    }


    public boolean isInitialized(de.pokerno.protocol.rpc.Request message) {
        return true;
    }


    public void mergeFrom(Input input, de.pokerno.protocol.rpc.Request message) throws IOException {
    ...
    public void mergeFrom(Input input, de.pokerno.protocol.rpc.Request message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_TYPE:
    ...
    public void writeTo(Output output, de.pokerno.protocol.rpc.Request message) throws IOException {
    ...
    public void writeTo(Output output, de.pokerno.protocol.rpc.Request message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_TYPE:
