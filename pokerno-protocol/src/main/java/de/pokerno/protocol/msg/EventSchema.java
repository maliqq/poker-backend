...
public class EventSchema
    ...
    static final Event DEFAULT_INSTANCE = new Event();
    static final Schema<Event> SCHEMA = new EventSchema();

    public static Event getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<Event> getSchema() { return SCHEMA; }
    ...
    public boolean isInitialized(Event message) {
        return true;
    }


    public void mergeFrom(Input input, Event message) throws IOException {
    ...
    public void mergeFrom(Input input, Event message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_TYPE:
    ...
    public void writeTo(Output output, Event message) throws IOException {
    ...
    public void writeTo(Output output, Event message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_TYPE:
