...
public class DealEventSchema
       implements Schema<de.pokerno.protocol.msg.DealEvent> {
    ...
    static final de.pokerno.protocol.msg.DealEvent DEFAULT_INSTANCE = new de.pokerno.protocol.msg.DealEvent();
    static final Schema<de.pokerno.protocol.msg.DealEvent> SCHEMA = new DealEventSchema();

    public static de.pokerno.protocol.msg.DealEvent getDefaultInstance() { return DEFAULT_INSTANCE; }
    public static Schema<de.pokerno.protocol.msg.DealEvent> getSchema() { return SCHEMA; }
    ...
    public de.pokerno.protocol.msg.DealEvent newMessage() {
        return new de.pokerno.protocol.msg.DealEvent();
    }

    public Class<de.pokerno.protocol.msg.DealEvent> typeClass() {
        return de.pokerno.protocol.msg.DealEvent.class;
    }

    public String messageName() {
        return de.pokerno.protocol.msg.DealEvent.class.getSimpleName();
    }

    public String messageFullName() {
        return de.pokerno.protocol.msg.DealEvent.class.getName();
    }


    public boolean isInitialized(de.pokerno.protocol.msg.DealEvent message) {
        return true;
    }


    public void mergeFrom(Input input, de.pokerno.protocol.msg.DealEvent message) throws IOException {
    ...
    public void mergeFrom(Input input, de.pokerno.protocol.msg.DealEvent message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                return;
            case FIELD_TYPE:
    ...
    public void writeTo(Output output, de.pokerno.protocol.msg.DealEvent message) throws IOException {
    ...
    public void writeTo(Output output, de.pokerno.protocol.msg.DealEvent message, int fieldIx) throws IOException {
        switch (fieldIx) {
            case FIELD_NONE:
                break;
            case FIELD_TYPE:
